...
const projectList = [
    { id: 1, owner: 'serenetay', img: img1, name: 'Project 1' },
    { id: 2, owner: 'jeffrey', img: img2, name: 'Project 2' },
    { id: 3, owner: 'leonardtng', img: img3, name: 'Project 3' },
    { id: 4, owner: 'serenetay', img: img4, name: 'Project 4' },
    { id: 5, owner: 'serenetay', img: img5, name: 'Project 5' }, 
];
